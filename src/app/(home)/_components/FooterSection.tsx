...
const FooterSection = () => {
  return (
    <p className=" flex flex-col mx-auto lg:mx-0  w-[281px] lg:w-[516px] gap-[19px] lg:gap-3 font-figtree font-medium leading-[100%] tracking-normal align-middle text-[#ABABAB] order-2 lg:order-3">
